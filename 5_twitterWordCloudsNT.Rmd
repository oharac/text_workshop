...
This query searched **"#blackhistorymonth"** and limited the response to **500 tweets**. Since we can't access Twitter without an active token, this script just pulls in a static CSV previously pulled from Twitter so that the word cloud code can be run.
...
# 
# write.csv(bhm_tweets2, file="data/bhmTweets.csv",row.names=F)

bhm_tweets<-read_csv("data/bhmTweets.csv")
